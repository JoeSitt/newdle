...
{
    Event a("Party");
    a.addSession(1, 1, 9, 9, 30, 1, 1, 9, 11, 30);
    a.addAttendee(1, 1, 9, 9, 30, "John");
    a.addAttendee(1, 1, 9, 9, 30, "a");
    a.addAttendee(1, 1, 9, 9, 30, "J");
    a.addAttendee(1, 1, 9, 9, 30, "abigail");
    a.addAttendee(1, 1, 9, 10, 30, "new");
    a.addAttendee(1, 1, 9, 10, 0, "newer");
