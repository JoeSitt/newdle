run : main.o Manager.o Event.o TimeSlot.o Executive.o Valid.o
	g++ -Lboost_1_55_0/lib -Wl,-rpath=boost_1_55_0/lib -Wall -g -std=c++11 main.o Event.o Manager.o TimeSlot.o Executive.o Valid.o -o run -lboost_serialization
